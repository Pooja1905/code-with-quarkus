...
- Camel Tika ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/tika.html)): Parse documents and extract metadata and text using Apache Tika
